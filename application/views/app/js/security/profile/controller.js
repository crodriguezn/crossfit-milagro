        ...
        self.$table.dataTable({
            ...
            fnDrawCallback: function ()
            {
                ...
                $('.dt-col-option').each(function () {
                    ...
                    if (Profile_Base.permissions.access_permissions)
                    {
                        $('.dt-action-view-permission', $html).click(function () {
                            location.href = Core.site_url('app/security_profile/listing/' + data);
                            //Profile_Modal.open(data);
                        });
                    }
                    $(this).after($html);
...
var Profile_Modal = {
    init: function ()
    {
        ...
        $('button.action-save', self.$modal).click(function () {
            if (Profile_Base.permissions.create || Profile_Base.permissions.update)
            {
                self.actionSave();
            }
        });
