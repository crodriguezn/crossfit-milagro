...
var Modal_UserAcount = {
    ...
    formType: function (type /* new, edit, view */)
    {
        ...
        else if (type == 'view')
        {
            ...
            if (user_settings_form_default.permissions.update)
            {
    ...
    formReadOnly: function (isFormReadOnly)
    {
        ...
        /*if (isFormReadOnly)
         {
         $('[name="tipo_documento"]', self.$modal).prop('disabled', true);
         $('[name="gender"]', self.$modal).prop('disabled', true);
         $('[name="estado_civil"]', self.$modal).prop('disabled', true);
         $('[name="tipo_sangre"]', self.$modal).prop('disabled', true);
         $('[name="id_pais"]', self.$modal).prop('disabled', true);
         $('[name="id_provincia"]', self.$modal).prop('disabled', true);
         $('[name="id_ciudad"]', self.$modal).prop('disabled', true);
         }
         else
         {
         $('[name="tipo_documento"]', self.$modal).select2('enable', true);
         $('[name="gender"]', self.$modal).select2('enable', true);
         $('[name="estado_civil"]', self.$modal).select2('enable', true);
         $('[name="tipo_sangre"]', self.$modal).select2('enable', true);
         $('[name="id_pais"]', self.$modal).select2('enable', true);
         $('[name="id_provincia"]', self.$modal).select2('enable', true);
         $('[name="id_ciudad"]', self.$modal).select2('enable', true);
         }*/
