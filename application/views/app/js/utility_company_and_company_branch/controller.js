...
//        $('.el-fin-pais', self.$modal).show();
        Core.Loading.wait(true, $('.el-fin-pais', self.$modal));
...
//            $('.el-fin-pais', self.$modal).hide();
            Core.Loading.wait(false, $('.el-fin-pais', self.$modal));
...
//        $('.el-fin-provincia', self.$modal).show();
        Core.Loading.wait(true, $('.el-fin-provincia', self.$modal));
...
//            $('.el-fin-provincia', self.$modal).hide();
            Core.Loading.wait(false, $('.el-fin-provincia', self.$modal));
...
//            $('.el-fin-ciudad', self.$modal).hide();
            Core.Loading.wait(false, $('.el-fin-ciudad', self.$modal));
            if (fLoad)
            {
                fLoad();
            }
    ...
    formReadOnly: function (isFormReadOnly)
    {
        ...
        $('select[name="id_pais"]', self.$modal).select2('enable', !isFormReadOnly);
        $('select[name="id_provincia"]', self.$modal).select2('enable', !isFormReadOnly);
        $('select[name="id_ciudad"]', self.$modal).select2('enable', !isFormReadOnly);
        $.uniform.update();
    },
