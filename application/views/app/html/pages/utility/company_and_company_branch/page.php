...
<div class="tabbable">
    ...
    <div class="tab-content pill-content">
        <div id="tab_company_data" class="tab-pane fade active in">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h6 class="panel-title"><i class="icon-paragraph-justify2"></i> Empresa</h6>
                </div>
                                ...
                                <div class="panel panel-default panel-logo">
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label text-right">Logo Empresarial:</label>
                                                    <div class="col-sm-8">
        ...
        <div id="tab_company_branches" class="tab-pane fade">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h6 class="panel-title"><i class="icon-office"></i> Listado de Sucursales</h6>
<!--                    <div class="panel-icons-group">
                        <a href="javascript:;" class="btn btn-link btn-icon action-refresh">
